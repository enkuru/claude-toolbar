...
- **Session presence** – lists the most recent Claude sessions with status icons (`🟢` running, `🔵` running tools, `🟠` awaiting approval, `⚪️` idle) and relative last-activity times.
