...
class ClaudeToolbarApp(rumps.App):
    def __init__(self, config: Optional[ToolbarConfig] = None):
        ...
        self.usage_last_month_item = rumps.MenuItem("Last month: …")
        self.usage_all_time_item = rumps.MenuItem("All time: …")
    ...
    def _update_loading_titles(self) -> None:
        ...
        self.usage_last_month_item.title = f"Last month: loading{suffix}"
        self.usage_all_time_item.title = f"All time: loading{suffix}"
    ...
    def _render_loading_state(self) -> None:
        ...
        self.menu.add(self.usage_last_month_item)
        self.menu.add(self.usage_all_time_item)
    ...
    def _update_usage_section(
        ...
        if self.tracker.is_initializing():
            ...
            self.usage_last_month_item.title = "Last month: loading…"
            self.usage_all_time_item.title = "All time: loading…"
